...
$ref = 'psicologos estres depresion ansiedad duelo';
$ref_mot_cle ='psicologos estres depresion ansiedad duelo';
$id_page = "3";
?>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="contenido container">
        <h2>psicologos estres depresion ansiedad duelo</h2><br />
        <h3>
